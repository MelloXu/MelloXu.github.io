...
<html<?php echo ' class="menu-' . ($menu_enabled ? 'enabled' : 'disabled sidebar-closed') . '"'; ?>>
  <head>
    ...
    <meta name="robots" content="noindex,nofollow">
    <title><?php echo $init_path ? basename($init_path) : '棉花糖的私密网盘，欢迎下载！'; ?></title>
...
var CodeMirror = {};
    ...
    <!-- files -->
    <script src="https://cdn.jsdelivr.net/gh/qiantigers/files.photo.gallery@1.1/js/files.js"></script>
